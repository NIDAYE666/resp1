...
<!-- discounts-->
		    ...
		    <div class="service-breadcrumb">
				<div class="container">
					<div class="wthree_service_breadcrumb_left">
						<ul>
							<li><a href="index.html">é¦é¡µ</a> <i>|</i></li>
							<li>ä¿é©</li>
						</ul>
					</div>
				  ...
				  <div class="insurance-info">
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="headingOne">
								<h4 class="panel-title asd">
									<a class="pa_italic" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">ç¬¬ä¸æ­¥  : å³äºçº¦ä¼ <span class="glyphicon glyphicon glyphicon-chevron-up" aria-hidden="true"></span>
									</a>
								</h4>
							</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="headingTwo">
								<h4 class="panel-title asd">
									<a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">ç¬¬äºæ­¥ : æ±½è½¦ç»è<span class="glyphicon glyphicon glyphicon-chevron-up" aria-hidden="true"></span>
									</a>
								</h4>
							</div>
					   ...
					   <input type="submit" value="Find Car">
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="headingThree">
								<h4 class="panel-title asd">
									<a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">ç¬¬ä¸æ­¥ : TOYOTA INNOVA CRYSTA | LAUNCH VIDEO | AUTO EXPO 2016 <span class="glyphicon glyphicon glyphicon-chevron-up" aria-hidden="true"></span>
									</a>
								</h4>
							</div>
		...
		<div class="faq main-grid-border">
			<h3 class="tittle">å¸¸è§é®é¢è§£ç­</h3>
			  <dl class="faq-list">
				<dt class="faq-list_h">
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				<h2><a href="index.html">Catchy Carz <span>Eye it â try it â buy it!</span></a></h2>
			</div>
