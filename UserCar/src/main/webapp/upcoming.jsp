				 ...
				 <div class="col-md-9 tips-info">
					 <div class="news-grid">
					  ...
					  <div class="news-grid">
					    ...
					    <div class="news-text coming">
							...
							<h5>Launched On: 07-July-2016</h5>
							<p class="news">Price: $ 36,000 Ex-showroom, New York</p>
							<h6>Not rated yet,<a href="single.html"> Be the first one to write a review</a></h6>
							<a href="price.html" class="read hvr-shutter-in-horizontal">Check on-road price</a>
							<ul class="p-t">
							  <li><a href="single.html">Photos</a></li>
					 ...
					 <div class="news-grid">
					    ...
					    <div class="news-text coming">
							...
							<h5>Launched On: 07-July-2016</h5>
							<p class="news">Price: $ 32,000 Ex-showroom, New York</p>
							<h6>Not rated yet,<a href="single.html"> Be the first one to write a review</a></h6>
							<a href="price.html" class="read hvr-shutter-in-horizontal">Check on-road price</a>
							<ul class="p-t">
							  <li><a href="single.html">Photos</a></li>
					   ...
					   <div class="news-grid">
					    ...
					    <div class="news-text coming">
							...
							<h5>Launched On: 07-July-2016</h5>
							<p class="news">Price: $ 35,000 Ex-showroom, New York</p>
							<h6>Not rated yet,<a href="single.html"> Be the first one to write a review</a></h6>
							<a href="price.html" class="read hvr-shutter-in-horizontal">Check on-road price</a>
							<ul class="p-t">
							  <li><a href="single.html">Photos</a></li>
					  ...
					  <div class="news-grid">
					    <div class="news-img up">
						  <a href="single.html"> <img src="images/f5.jpeg" alt=" " class="img-responsive"></a>
						  <span class="price1">NEW</span>
						</div>
					    <div class="news-text coming">
						    <h3><a href="single.html">Ferrari F430</a></h3>
							<h5>Launched On: 07-July-2016</h5>
							<p class="news">Price: $ 34,000 Ex-showroom, New York</p>
							<h6>Not rated yet,<a href="single.html"> Be the first one to write a review</a></h6>
							<a href="price.html" class="read hvr-shutter-in-horizontal">Check on-road price</a>
							<ul class="p-t">
							  <li><a href="single.html">Photos</a></li>
